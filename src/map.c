...
static map_chunk *Get_Map_Chunk_By_Chunk_Position_(map *Map, int Chunk_X, int Chunk_Y, int Chunk_Z, bool Insert_If_Not_Found)
{
   map_chunk *Result = 0;
...
static map_chunk *Get_Map_Chunk_(map *Map, int X, int Y, int Z, bool Insert_If_Not_Found)
{
   ...
   map_chunk *Result = Get_Map_Chunk_By_Chunk_Position_(Map, Chunk_P.X, Chunk_P.Y, Chunk_P.Z, Insert_If_Not_Found);
   return(Result);
}

static map_chunk *Get_Map_Chunk(map *Map, int X, int Y, int Z)
{
   map_chunk *Result = Get_Map_Chunk_(Map, X, Y, Z, false);
   return(Result);
}

static map_chunk *Get_Map_Chunk_By_Chunk_Position(map *Map, int Chunk_X, int Chunk_Y, int Chunk_Z)
{
   map_chunk *Result = Get_Map_Chunk_By_Chunk_Position_(Map, Chunk_X, Chunk_Y, Chunk_Z, false);
   return(Result);
}

static map_chunk *Insert_Map_Chunk(map *Map, int X, int Y, int Z)
{
   map_chunk *Result = Get_Map_Chunk_(Map, X, Y, Z, true);
   return(Result);
}
